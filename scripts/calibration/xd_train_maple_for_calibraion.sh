...
# for EXP_NAME in Baseline ClassficationAndMDCA ClassficationAndMDCA_dist KL_match_classwise L2_ece_weighted MBLS
# do
DIR=output/${EXP_NAME}/${DATASET}/${TRAINER}/${CFG}_${SHOTS}shots/seed${SEED}
...
#!/bin/bash
#SBATCH --job-name=maple_imagenet_1k
#SBATCH --gres gpu:1
#SBATCH --nodes 1
#SBATCH --cpus-per-task=10
